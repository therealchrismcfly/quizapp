...
//missing - const homepage
const bookmarkpage = document.querySelector('[data-js="page_bookmarks"]');
const createpage = document.querySelector('[data-js="page_create"]');
const profilepage = document.querySelector('[data-js="page_profile"]');
